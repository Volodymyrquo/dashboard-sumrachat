  ...
  return (
    <nav className='nav-bar'>
      ...
      <ul>
        <Link to='/chats'>
          <li
            className={windowLocation === `/chats` ? 'active' : null}
            onClick={() => {
              handleOnClick(`/chats`)
            }}>
        ...
        <Link to='/settings'>
          <li
            className={windowLocation === `/settings` ? 'active' : null}
            onClick={() => {
      ...
      <ul>
        <Link to='/referrals'>
          <li
            className={windowLocation === `/referrals` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='/rewards'>
          <li
            className={windowLocation === `/rewards` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='/divits-bonus-plaza'>
          <li
            className={
              windowLocation === `/divits-bonus-plaza` ? 'active' : null
            }
            onClick={() => {
        ...
        <Link to='/global-earnings'>
          <li
            className={windowLocation === `/global-earnings` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='/leaderboard'>
          <li
            className={windowLocation === `/leaderboard` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='statistics'>
          <li
            className={windowLocation === `/statistics` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='contact-book'>
          <li
            className={windowLocation === `/contact-book` ? 'active' : null}
            onClick={() => {
        ...
        <Link to='pioneer-membership'>
          <li
            className={
              windowLocation === `/pioneer-membership` ? 'active' : null
            }
            onClick={() => {
